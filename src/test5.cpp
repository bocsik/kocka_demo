...
void pick(moveit::planning_interface::MoveGroupInterface& move_group,moveit::planning_interface::PlanningSceneInterface& planning_scene_interface, std::string object)
{
  ...
  pre_grasp_pose.position.z = cube_pose.position.z + 0.22;  //0.29 volt
...
void place(moveit::planning_interface::MoveGroupInterface& move_group,moveit::planning_interface::PlanningSceneInterface& planning_scene_interface, std::string object, geometry_msgs::Pose place_pose)
{
  ...
  pre_place_pose.position.z = place_pose.position.z + height * 0.045 + 0.22;  //0.29 volt a biztonsági magasság
...
void addCollisionObjects(moveit::planning_interface::PlanningSceneInterface& planning_scene_interface)
{
  ...
  collision_objects[1].primitive_poses[0].position.z = CUBE_SIZE / 2 + 0.2;
  // END_SUB_TUTORIAL
  ...
  collision_objects[2].primitive_poses[0].position.z = CUBE_SIZE / 2 + 0.2;
  // END_SUB_TUTORIAL
  ...
  collision_objects[3].primitive_poses[0].position.z = CUBE_SIZE / 2 + 0.2;
  // END_SUB_TUTORIAL
